 ...
 */
@JsonAdapter(OfflineConversionServiceUploadSourceType.Adapter.class)
public enum OfflineConversionServiceUploadSourceType {
  ...
  public static class Adapter extends TypeAdapter<OfflineConversionServiceUploadSourceType> {
    @Override
    public void write(final JsonWriter jsonWriter, final OfflineConversionServiceUploadSourceType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OfflineConversionServiceUploadSourceType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OfflineConversionServiceUploadSourceType.fromValue(value);
    }
  }
}
