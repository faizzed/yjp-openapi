 ...
 */
@JsonAdapter(CampaignServiceIsRemove.Adapter.class)
public enum CampaignServiceIsRemove {
  ...
  public static class Adapter extends TypeAdapter<CampaignServiceIsRemove> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignServiceIsRemove enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignServiceIsRemove read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignServiceIsRemove.fromValue(value);
    }
  }
}
