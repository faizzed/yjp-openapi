 ...
 */
@JsonAdapter(CampaignServiceAppStore.Adapter.class)
public enum CampaignServiceAppStore {
  ...
  public static class Adapter extends TypeAdapter<CampaignServiceAppStore> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignServiceAppStore enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignServiceAppStore read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignServiceAppStore.fromValue(value);
    }
  }
}
