 ...
 */
@JsonAdapter(AdGroupAdServiceAppStore.Adapter.class)
public enum AdGroupAdServiceAppStore {
  ...
  public static class Adapter extends TypeAdapter<AdGroupAdServiceAppStore> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupAdServiceAppStore enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupAdServiceAppStore read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupAdServiceAppStore.fromValue(value);
    }
  }
}
