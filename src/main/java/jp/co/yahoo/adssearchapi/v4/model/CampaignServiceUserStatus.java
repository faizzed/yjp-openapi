 ...
 */
@JsonAdapter(CampaignServiceUserStatus.Adapter.class)
public enum CampaignServiceUserStatus {
  ...
  public static class Adapter extends TypeAdapter<CampaignServiceUserStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignServiceUserStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignServiceUserStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignServiceUserStatus.fromValue(value);
    }
  }
}
