 ...
 */
@JsonAdapter(CampaignExportServiceUserStatus.Adapter.class)
public enum CampaignExportServiceUserStatus {
  ...
  public static class Adapter extends TypeAdapter<CampaignExportServiceUserStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignExportServiceUserStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignExportServiceUserStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignExportServiceUserStatus.fromValue(value);
    }
  }
}
