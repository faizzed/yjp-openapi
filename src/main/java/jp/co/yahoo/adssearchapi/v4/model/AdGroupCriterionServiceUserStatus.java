 ...
 */
@JsonAdapter(AdGroupCriterionServiceUserStatus.Adapter.class)
public enum AdGroupCriterionServiceUserStatus {
  ...
  public static class Adapter extends TypeAdapter<AdGroupCriterionServiceUserStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupCriterionServiceUserStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupCriterionServiceUserStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupCriterionServiceUserStatus.fromValue(value);
    }
  }
}
