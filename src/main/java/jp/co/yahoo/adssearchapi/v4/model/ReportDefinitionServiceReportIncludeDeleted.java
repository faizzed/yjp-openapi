 ...
 */
@JsonAdapter(ReportDefinitionServiceReportIncludeDeleted.Adapter.class)
public enum ReportDefinitionServiceReportIncludeDeleted {
  ...
  public static class Adapter extends TypeAdapter<ReportDefinitionServiceReportIncludeDeleted> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReportDefinitionServiceReportIncludeDeleted enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReportDefinitionServiceReportIncludeDeleted read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReportDefinitionServiceReportIncludeDeleted.fromValue(value);
    }
  }
}
