 ...
 */
@JsonAdapter(CampaignServiceSettingType.Adapter.class)
public enum CampaignServiceSettingType {
  ...
  public static class Adapter extends TypeAdapter<CampaignServiceSettingType> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignServiceSettingType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignServiceSettingType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignServiceSettingType.fromValue(value);
    }
  }
}
