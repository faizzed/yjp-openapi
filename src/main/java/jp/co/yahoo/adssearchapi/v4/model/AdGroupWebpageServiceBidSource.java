 ...
 */
@JsonAdapter(AdGroupWebpageServiceBidSource.Adapter.class)
public enum AdGroupWebpageServiceBidSource {
  ...
  public static class Adapter extends TypeAdapter<AdGroupWebpageServiceBidSource> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupWebpageServiceBidSource enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupWebpageServiceBidSource read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupWebpageServiceBidSource.fromValue(value);
    }
  }
}
