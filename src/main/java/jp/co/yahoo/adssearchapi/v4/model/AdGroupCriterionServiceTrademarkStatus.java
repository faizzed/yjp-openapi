 ...
 */
@JsonAdapter(AdGroupCriterionServiceTrademarkStatus.Adapter.class)
public enum AdGroupCriterionServiceTrademarkStatus {
  ...
  public static class Adapter extends TypeAdapter<AdGroupCriterionServiceTrademarkStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupCriterionServiceTrademarkStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupCriterionServiceTrademarkStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupCriterionServiceTrademarkStatus.fromValue(value);
    }
  }
}
