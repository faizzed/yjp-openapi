 ...
 */
@JsonAdapter(PageFeedItemServiceBulkLang.Adapter.class)
public enum PageFeedItemServiceBulkLang {
  ...
  public static class Adapter extends TypeAdapter<PageFeedItemServiceBulkLang> {
    @Override
    public void write(final JsonWriter jsonWriter, final PageFeedItemServiceBulkLang enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PageFeedItemServiceBulkLang read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PageFeedItemServiceBulkLang.fromValue(value);
    }
  }
}
