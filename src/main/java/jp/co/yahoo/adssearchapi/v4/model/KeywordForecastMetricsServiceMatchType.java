 ...
 */
@JsonAdapter(KeywordForecastMetricsServiceMatchType.Adapter.class)
public enum KeywordForecastMetricsServiceMatchType {
  ...
  public static class Adapter extends TypeAdapter<KeywordForecastMetricsServiceMatchType> {
    @Override
    public void write(final JsonWriter jsonWriter, final KeywordForecastMetricsServiceMatchType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public KeywordForecastMetricsServiceMatchType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return KeywordForecastMetricsServiceMatchType.fromValue(value);
    }
  }
}
