 ...
 */
@JsonAdapter(CampaignTargetServiceTargetingStatus.Adapter.class)
public enum CampaignTargetServiceTargetingStatus {
  ...
  public static class Adapter extends TypeAdapter<CampaignTargetServiceTargetingStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignTargetServiceTargetingStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignTargetServiceTargetingStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignTargetServiceTargetingStatus.fromValue(value);
    }
  }
}
