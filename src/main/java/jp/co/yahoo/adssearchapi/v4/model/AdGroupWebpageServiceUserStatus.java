 ...
 */
@JsonAdapter(AdGroupWebpageServiceUserStatus.Adapter.class)
public enum AdGroupWebpageServiceUserStatus {
  ...
  public static class Adapter extends TypeAdapter<AdGroupWebpageServiceUserStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupWebpageServiceUserStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupWebpageServiceUserStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupWebpageServiceUserStatus.fromValue(value);
    }
  }
}
