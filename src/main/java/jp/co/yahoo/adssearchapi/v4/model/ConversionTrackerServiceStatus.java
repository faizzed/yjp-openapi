 ...
 */
@JsonAdapter(ConversionTrackerServiceStatus.Adapter.class)
public enum ConversionTrackerServiceStatus {
  ...
  public static class Adapter extends TypeAdapter<ConversionTrackerServiceStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ConversionTrackerServiceStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ConversionTrackerServiceStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ConversionTrackerServiceStatus.fromValue(value);
    }
  }
}
