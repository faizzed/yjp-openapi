 ...
 */
@JsonAdapter(AdGroupCriterionServiceIsRemove.Adapter.class)
public enum AdGroupCriterionServiceIsRemove {
  ...
  public static class Adapter extends TypeAdapter<AdGroupCriterionServiceIsRemove> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupCriterionServiceIsRemove enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupCriterionServiceIsRemove read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupCriterionServiceIsRemove.fromValue(value);
    }
  }
}
