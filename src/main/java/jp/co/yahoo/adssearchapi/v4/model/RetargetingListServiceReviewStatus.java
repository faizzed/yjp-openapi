 ...
 */
@JsonAdapter(RetargetingListServiceReviewStatus.Adapter.class)
public enum RetargetingListServiceReviewStatus {
  ...
  public static class Adapter extends TypeAdapter<RetargetingListServiceReviewStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final RetargetingListServiceReviewStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RetargetingListServiceReviewStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RetargetingListServiceReviewStatus.fromValue(value);
    }
  }
}
