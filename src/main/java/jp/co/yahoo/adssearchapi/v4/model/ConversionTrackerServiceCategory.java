...
public enum ConversionTrackerServiceCategory {
  ...
  public static class Adapter extends TypeAdapter<ConversionTrackerServiceCategory> {
    @Override
    public void write(final JsonWriter jsonWriter, final ConversionTrackerServiceCategory enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ConversionTrackerServiceCategory read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ConversionTrackerServiceCategory.fromValue(value);
    }
  }
}
