...
public class KeywordEstimatorServiceAdGroupEstimateRequest {
  ...
  public static final String SERIALIZED_NAME_KEYWORD_ESTIMATE_REQUESTS = "keywordEstimateRequests";
  @SerializedName(SERIALIZED_NAME_KEYWORD_ESTIMATE_REQUESTS)
  private List<KeywordEstimatorServiceKeywordEstimateRequest> keywordEstimateRequests = new ArrayList<KeywordEstimatorServiceKeywordEstimateRequest>();
