 ...
 */
@JsonAdapter(AdGroupWebpageServiceWebpageConditionType.Adapter.class)
public enum AdGroupWebpageServiceWebpageConditionType {
  ...
  public static class Adapter extends TypeAdapter<AdGroupWebpageServiceWebpageConditionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupWebpageServiceWebpageConditionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupWebpageServiceWebpageConditionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupWebpageServiceWebpageConditionType.fromValue(value);
    }
  }
}
