 ...
 */
@JsonAdapter(BudgetOrderServiceLimitChargeType.Adapter.class)
public enum BudgetOrderServiceLimitChargeType {
  ...
  public static class Adapter extends TypeAdapter<BudgetOrderServiceLimitChargeType> {
    @Override
    public void write(final JsonWriter jsonWriter, final BudgetOrderServiceLimitChargeType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public BudgetOrderServiceLimitChargeType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return BudgetOrderServiceLimitChargeType.fromValue(value);
    }
  }
}
