 ...
 */
@JsonAdapter(FeedServicePlaceholderField.Adapter.class)
public enum FeedServicePlaceholderField {
  ...
  public static class Adapter extends TypeAdapter<FeedServicePlaceholderField> {
    @Override
    public void write(final JsonWriter jsonWriter, final FeedServicePlaceholderField enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FeedServicePlaceholderField read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FeedServicePlaceholderField.fromValue(value);
    }
  }
}
