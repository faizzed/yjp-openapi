 ...
 */
@JsonAdapter(CampaignTargetServiceDayOfWeek.Adapter.class)
public enum CampaignTargetServiceDayOfWeek {
  ...
  public static class Adapter extends TypeAdapter<CampaignTargetServiceDayOfWeek> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignTargetServiceDayOfWeek enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignTargetServiceDayOfWeek read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignTargetServiceDayOfWeek.fromValue(value);
    }
  }
}
