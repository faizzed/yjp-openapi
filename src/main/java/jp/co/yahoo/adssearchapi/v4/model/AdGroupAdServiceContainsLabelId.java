 ...
 */
@JsonAdapter(AdGroupAdServiceContainsLabelId.Adapter.class)
public enum AdGroupAdServiceContainsLabelId {
  ...
  public static class Adapter extends TypeAdapter<AdGroupAdServiceContainsLabelId> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupAdServiceContainsLabelId enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupAdServiceContainsLabelId read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupAdServiceContainsLabelId.fromValue(value);
    }
  }
}
