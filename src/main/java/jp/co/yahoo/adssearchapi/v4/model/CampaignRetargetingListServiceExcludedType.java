 ...
 */
@JsonAdapter(CampaignRetargetingListServiceExcludedType.Adapter.class)
public enum CampaignRetargetingListServiceExcludedType {
  ...
  public static class Adapter extends TypeAdapter<CampaignRetargetingListServiceExcludedType> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignRetargetingListServiceExcludedType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignRetargetingListServiceExcludedType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignRetargetingListServiceExcludedType.fromValue(value);
    }
  }
}
