 ...
 */
@JsonAdapter(CampaignTargetServiceTargetType.Adapter.class)
public enum CampaignTargetServiceTargetType {
  ...
  public static class Adapter extends TypeAdapter<CampaignTargetServiceTargetType> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignTargetServiceTargetType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignTargetServiceTargetType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignTargetServiceTargetType.fromValue(value);
    }
  }
}
