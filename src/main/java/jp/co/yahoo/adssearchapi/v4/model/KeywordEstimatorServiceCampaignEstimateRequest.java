...
public class KeywordEstimatorServiceCampaignEstimateRequest {
  public static final String SERIALIZED_NAME_AD_GROUP_ESTIMATE_REQUESTS = "adGroupEstimateRequests";
  @SerializedName(SERIALIZED_NAME_AD_GROUP_ESTIMATE_REQUESTS)
  private List<KeywordEstimatorServiceAdGroupEstimateRequest> adGroupEstimateRequests = new ArrayList<KeywordEstimatorServiceAdGroupEstimateRequest>();
