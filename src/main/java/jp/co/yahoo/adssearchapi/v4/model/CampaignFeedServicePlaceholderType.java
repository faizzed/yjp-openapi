 ...
 */
@JsonAdapter(CampaignFeedServicePlaceholderType.Adapter.class)
public enum CampaignFeedServicePlaceholderType {
  ...
  public static class Adapter extends TypeAdapter<CampaignFeedServicePlaceholderType> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignFeedServicePlaceholderType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignFeedServicePlaceholderType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignFeedServicePlaceholderType.fromValue(value);
    }
  }
}
