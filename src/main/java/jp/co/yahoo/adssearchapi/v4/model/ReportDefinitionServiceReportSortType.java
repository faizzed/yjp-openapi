 ...
 */
@JsonAdapter(ReportDefinitionServiceReportSortType.Adapter.class)
public enum ReportDefinitionServiceReportSortType {
  ...
  public static class Adapter extends TypeAdapter<ReportDefinitionServiceReportSortType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReportDefinitionServiceReportSortType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReportDefinitionServiceReportSortType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReportDefinitionServiceReportSortType.fromValue(value);
    }
  }
}
