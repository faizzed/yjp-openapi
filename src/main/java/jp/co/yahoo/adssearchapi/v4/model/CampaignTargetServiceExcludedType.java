 ...
 */
@JsonAdapter(CampaignTargetServiceExcludedType.Adapter.class)
public enum CampaignTargetServiceExcludedType {
  ...
  public static class Adapter extends TypeAdapter<CampaignTargetServiceExcludedType> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignTargetServiceExcludedType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignTargetServiceExcludedType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignTargetServiceExcludedType.fromValue(value);
    }
  }
}
