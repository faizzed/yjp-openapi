 ...
 */
@JsonAdapter(AccountManagementServiceIsTestAccount.Adapter.class)
public enum AccountManagementServiceIsTestAccount {
  ...
  public static class Adapter extends TypeAdapter<AccountManagementServiceIsTestAccount> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountManagementServiceIsTestAccount enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountManagementServiceIsTestAccount read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountManagementServiceIsTestAccount.fromValue(value);
    }
  }
}
