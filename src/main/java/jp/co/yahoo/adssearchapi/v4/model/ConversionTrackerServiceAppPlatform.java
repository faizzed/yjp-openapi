 ...
 */
@JsonAdapter(ConversionTrackerServiceAppPlatform.Adapter.class)
public enum ConversionTrackerServiceAppPlatform {
  ...
  public static class Adapter extends TypeAdapter<ConversionTrackerServiceAppPlatform> {
    @Override
    public void write(final JsonWriter jsonWriter, final ConversionTrackerServiceAppPlatform enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ConversionTrackerServiceAppPlatform read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ConversionTrackerServiceAppPlatform.fromValue(value);
    }
  }
}
