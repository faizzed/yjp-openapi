 ...
 */
@JsonAdapter(AdGroupAdServiceIsRemove.Adapter.class)
public enum AdGroupAdServiceIsRemove {
  ...
  public static class Adapter extends TypeAdapter<AdGroupAdServiceIsRemove> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupAdServiceIsRemove enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupAdServiceIsRemove read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupAdServiceIsRemove.fromValue(value);
    }
  }
}
