 ...
 */
@JsonAdapter(RetargetingListServiceLogicalCondition.Adapter.class)
public enum RetargetingListServiceLogicalCondition {
  ...
  public static class Adapter extends TypeAdapter<RetargetingListServiceLogicalCondition> {
    @Override
    public void write(final JsonWriter jsonWriter, final RetargetingListServiceLogicalCondition enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RetargetingListServiceLogicalCondition read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RetargetingListServiceLogicalCondition.fromValue(value);
    }
  }
}
