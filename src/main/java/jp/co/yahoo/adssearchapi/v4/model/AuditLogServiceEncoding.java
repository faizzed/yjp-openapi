 ...
 */
@JsonAdapter(AuditLogServiceEncoding.Adapter.class)
public enum AuditLogServiceEncoding {
  ...
  public static class Adapter extends TypeAdapter<AuditLogServiceEncoding> {
    @Override
    public void write(final JsonWriter jsonWriter, final AuditLogServiceEncoding enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AuditLogServiceEncoding read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AuditLogServiceEncoding.fromValue(value);
    }
  }
}
