 ...
 */
@JsonAdapter(AccountManagementServicePaymentType.Adapter.class)
public enum AccountManagementServicePaymentType {
  ...
  public static class Adapter extends TypeAdapter<AccountManagementServicePaymentType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountManagementServicePaymentType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountManagementServicePaymentType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountManagementServicePaymentType.fromValue(value);
    }
  }
}
