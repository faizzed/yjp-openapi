 ...
 */
@JsonAdapter(SharedCriterionServiceUse.Adapter.class)
public enum SharedCriterionServiceUse {
  ...
  public static class Adapter extends TypeAdapter<SharedCriterionServiceUse> {
    @Override
    public void write(final JsonWriter jsonWriter, final SharedCriterionServiceUse enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SharedCriterionServiceUse read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SharedCriterionServiceUse.fromValue(value);
    }
  }
}
