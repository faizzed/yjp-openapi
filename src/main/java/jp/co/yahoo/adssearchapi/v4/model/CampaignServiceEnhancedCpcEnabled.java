 ...
 */
@JsonAdapter(CampaignServiceEnhancedCpcEnabled.Adapter.class)
public enum CampaignServiceEnhancedCpcEnabled {
  ...
  public static class Adapter extends TypeAdapter<CampaignServiceEnhancedCpcEnabled> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignServiceEnhancedCpcEnabled enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignServiceEnhancedCpcEnabled read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignServiceEnhancedCpcEnabled.fromValue(value);
    }
  }
}
