 ...
 */
@JsonAdapter(AdGroupAdServiceUserStatus.Adapter.class)
public enum AdGroupAdServiceUserStatus {
  ...
  public static class Adapter extends TypeAdapter<AdGroupAdServiceUserStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupAdServiceUserStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupAdServiceUserStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupAdServiceUserStatus.fromValue(value);
    }
  }
}
