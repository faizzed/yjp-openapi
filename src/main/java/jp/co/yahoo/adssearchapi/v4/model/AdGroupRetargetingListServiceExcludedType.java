 ...
 */
@JsonAdapter(AdGroupRetargetingListServiceExcludedType.Adapter.class)
public enum AdGroupRetargetingListServiceExcludedType {
  ...
  public static class Adapter extends TypeAdapter<AdGroupRetargetingListServiceExcludedType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupRetargetingListServiceExcludedType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupRetargetingListServiceExcludedType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupRetargetingListServiceExcludedType.fromValue(value);
    }
  }
}
