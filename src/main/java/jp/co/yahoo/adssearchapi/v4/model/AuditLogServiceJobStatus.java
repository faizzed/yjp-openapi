 ...
 */
@JsonAdapter(AuditLogServiceJobStatus.Adapter.class)
public enum AuditLogServiceJobStatus {
  ...
  public static class Adapter extends TypeAdapter<AuditLogServiceJobStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AuditLogServiceJobStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AuditLogServiceJobStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AuditLogServiceJobStatus.fromValue(value);
    }
  }
}
