 ...
 */
@JsonAdapter(FeedItemServicePlaceholderField.Adapter.class)
public enum FeedItemServicePlaceholderField {
  ...
  public static class Adapter extends TypeAdapter<FeedItemServicePlaceholderField> {
    @Override
    public void write(final JsonWriter jsonWriter, final FeedItemServicePlaceholderField enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FeedItemServicePlaceholderField read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FeedItemServicePlaceholderField.fromValue(value);
    }
  }
}
