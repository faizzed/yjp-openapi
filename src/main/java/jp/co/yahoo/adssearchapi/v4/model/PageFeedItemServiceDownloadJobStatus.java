 ...
 */
@JsonAdapter(PageFeedItemServiceDownloadJobStatus.Adapter.class)
public enum PageFeedItemServiceDownloadJobStatus {
  ...
  public static class Adapter extends TypeAdapter<PageFeedItemServiceDownloadJobStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PageFeedItemServiceDownloadJobStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PageFeedItemServiceDownloadJobStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PageFeedItemServiceDownloadJobStatus.fromValue(value);
    }
  }
}
