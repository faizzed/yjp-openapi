 ...
 */
@JsonAdapter(AuditLogServiceLang.Adapter.class)
public enum AuditLogServiceLang {
  ...
  public static class Adapter extends TypeAdapter<AuditLogServiceLang> {
    @Override
    public void write(final JsonWriter jsonWriter, final AuditLogServiceLang enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AuditLogServiceLang read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AuditLogServiceLang.fromValue(value);
    }
  }
}
