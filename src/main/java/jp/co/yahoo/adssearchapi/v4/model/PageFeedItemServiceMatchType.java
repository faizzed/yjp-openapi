 ...
 */
@JsonAdapter(PageFeedItemServiceMatchType.Adapter.class)
public enum PageFeedItemServiceMatchType {
  ...
  public static class Adapter extends TypeAdapter<PageFeedItemServiceMatchType> {
    @Override
    public void write(final JsonWriter jsonWriter, final PageFeedItemServiceMatchType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PageFeedItemServiceMatchType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PageFeedItemServiceMatchType.fromValue(value);
    }
  }
}
