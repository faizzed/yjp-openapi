 ...
 */
@JsonAdapter(AdGroupAdServiceTextAssetApprovalStatus.Adapter.class)
public enum AdGroupAdServiceTextAssetApprovalStatus {
  ...
  public static class Adapter extends TypeAdapter<AdGroupAdServiceTextAssetApprovalStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupAdServiceTextAssetApprovalStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupAdServiceTextAssetApprovalStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupAdServiceTextAssetApprovalStatus.fromValue(value);
    }
  }
}
