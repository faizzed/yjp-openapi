 ...
 */
@JsonAdapter(CampaignServiceBiddingStrategyFailedReason.Adapter.class)
public enum CampaignServiceBiddingStrategyFailedReason {
  ...
  public static class Adapter extends TypeAdapter<CampaignServiceBiddingStrategyFailedReason> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignServiceBiddingStrategyFailedReason enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignServiceBiddingStrategyFailedReason read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignServiceBiddingStrategyFailedReason.fromValue(value);
    }
  }
}
