 ...
 */
@JsonAdapter(AdGroupCriterionServiceKeywordMatchType.Adapter.class)
public enum AdGroupCriterionServiceKeywordMatchType {
  ...
  public static class Adapter extends TypeAdapter<AdGroupCriterionServiceKeywordMatchType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupCriterionServiceKeywordMatchType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupCriterionServiceKeywordMatchType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupCriterionServiceKeywordMatchType.fromValue(value);
    }
  }
}
