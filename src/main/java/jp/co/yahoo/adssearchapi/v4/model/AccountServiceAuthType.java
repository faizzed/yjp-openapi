 ...
 */
@JsonAdapter(AccountServiceAuthType.Adapter.class)
public enum AccountServiceAuthType {
  ...
  public static class Adapter extends TypeAdapter<AccountServiceAuthType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountServiceAuthType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountServiceAuthType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountServiceAuthType.fromValue(value);
    }
  }
}
