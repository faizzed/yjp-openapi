 ...
 */
@JsonAdapter(FeedItemServiceCriterionTypeFeedItem.Adapter.class)
public enum FeedItemServiceCriterionTypeFeedItem {
  ...
  public static class Adapter extends TypeAdapter<FeedItemServiceCriterionTypeFeedItem> {
    @Override
    public void write(final JsonWriter jsonWriter, final FeedItemServiceCriterionTypeFeedItem enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FeedItemServiceCriterionTypeFeedItem read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FeedItemServiceCriterionTypeFeedItem.fromValue(value);
    }
  }
}
