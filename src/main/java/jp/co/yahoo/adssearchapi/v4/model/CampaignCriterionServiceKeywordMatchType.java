 ...
 */
@JsonAdapter(CampaignCriterionServiceKeywordMatchType.Adapter.class)
public enum CampaignCriterionServiceKeywordMatchType {
  ...
  public static class Adapter extends TypeAdapter<CampaignCriterionServiceKeywordMatchType> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignCriterionServiceKeywordMatchType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignCriterionServiceKeywordMatchType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignCriterionServiceKeywordMatchType.fromValue(value);
    }
  }
}
