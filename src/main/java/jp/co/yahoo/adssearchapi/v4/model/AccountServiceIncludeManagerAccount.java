 ...
 */
@JsonAdapter(AccountServiceIncludeManagerAccount.Adapter.class)
public enum AccountServiceIncludeManagerAccount {
  ...
  public static class Adapter extends TypeAdapter<AccountServiceIncludeManagerAccount> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountServiceIncludeManagerAccount enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountServiceIncludeManagerAccount read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountServiceIncludeManagerAccount.fromValue(value);
    }
  }
}
