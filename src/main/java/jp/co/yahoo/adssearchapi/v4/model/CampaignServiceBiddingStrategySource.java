 ...
 */
@JsonAdapter(CampaignServiceBiddingStrategySource.Adapter.class)
public enum CampaignServiceBiddingStrategySource {
  ...
  public static class Adapter extends TypeAdapter<CampaignServiceBiddingStrategySource> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignServiceBiddingStrategySource enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignServiceBiddingStrategySource read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignServiceBiddingStrategySource.fromValue(value);
    }
  }
}
