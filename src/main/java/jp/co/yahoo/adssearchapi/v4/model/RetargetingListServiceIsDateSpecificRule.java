 ...
 */
@JsonAdapter(RetargetingListServiceIsDateSpecificRule.Adapter.class)
public enum RetargetingListServiceIsDateSpecificRule {
  ...
  public static class Adapter extends TypeAdapter<RetargetingListServiceIsDateSpecificRule> {
    @Override
    public void write(final JsonWriter jsonWriter, final RetargetingListServiceIsDateSpecificRule enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RetargetingListServiceIsDateSpecificRule read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RetargetingListServiceIsDateSpecificRule.fromValue(value);
    }
  }
}
