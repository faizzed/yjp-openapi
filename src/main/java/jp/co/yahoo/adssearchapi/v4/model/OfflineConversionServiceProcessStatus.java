 ...
 */
@JsonAdapter(OfflineConversionServiceProcessStatus.Adapter.class)
public enum OfflineConversionServiceProcessStatus {
  ...
  public static class Adapter extends TypeAdapter<OfflineConversionServiceProcessStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final OfflineConversionServiceProcessStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OfflineConversionServiceProcessStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OfflineConversionServiceProcessStatus.fromValue(value);
    }
  }
}
