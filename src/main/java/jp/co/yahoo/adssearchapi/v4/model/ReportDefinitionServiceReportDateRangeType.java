 ...
 */
@JsonAdapter(ReportDefinitionServiceReportDateRangeType.Adapter.class)
public enum ReportDefinitionServiceReportDateRangeType {
  ...
  public static class Adapter extends TypeAdapter<ReportDefinitionServiceReportDateRangeType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReportDefinitionServiceReportDateRangeType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReportDefinitionServiceReportDateRangeType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReportDefinitionServiceReportDateRangeType.fromValue(value);
    }
  }
}
