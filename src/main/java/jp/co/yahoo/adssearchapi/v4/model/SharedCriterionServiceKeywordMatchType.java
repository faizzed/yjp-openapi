 ...
 */
@JsonAdapter(SharedCriterionServiceKeywordMatchType.Adapter.class)
public enum SharedCriterionServiceKeywordMatchType {
  ...
  public static class Adapter extends TypeAdapter<SharedCriterionServiceKeywordMatchType> {
    @Override
    public void write(final JsonWriter jsonWriter, final SharedCriterionServiceKeywordMatchType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SharedCriterionServiceKeywordMatchType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SharedCriterionServiceKeywordMatchType.fromValue(value);
    }
  }
}
