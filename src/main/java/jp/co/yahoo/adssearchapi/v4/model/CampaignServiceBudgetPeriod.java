 ...
 */
@JsonAdapter(CampaignServiceBudgetPeriod.Adapter.class)
public enum CampaignServiceBudgetPeriod {
  ...
  public static class Adapter extends TypeAdapter<CampaignServiceBudgetPeriod> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignServiceBudgetPeriod enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignServiceBudgetPeriod read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignServiceBudgetPeriod.fromValue(value);
    }
  }
}
