 ...
 */
@JsonAdapter(FeedItemServiceMinuteOfHour.Adapter.class)
public enum FeedItemServiceMinuteOfHour {
  ...
  public static class Adapter extends TypeAdapter<FeedItemServiceMinuteOfHour> {
    @Override
    public void write(final JsonWriter jsonWriter, final FeedItemServiceMinuteOfHour enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FeedItemServiceMinuteOfHour read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FeedItemServiceMinuteOfHour.fromValue(value);
    }
  }
}
