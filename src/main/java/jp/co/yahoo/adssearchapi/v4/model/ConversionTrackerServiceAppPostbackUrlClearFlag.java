 ...
 */
@JsonAdapter(ConversionTrackerServiceAppPostbackUrlClearFlag.Adapter.class)
public enum ConversionTrackerServiceAppPostbackUrlClearFlag {
  ...
  public static class Adapter extends TypeAdapter<ConversionTrackerServiceAppPostbackUrlClearFlag> {
    @Override
    public void write(final JsonWriter jsonWriter, final ConversionTrackerServiceAppPostbackUrlClearFlag enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ConversionTrackerServiceAppPostbackUrlClearFlag read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ConversionTrackerServiceAppPostbackUrlClearFlag.fromValue(value);
    }
  }
}
