 ...
 */
@JsonAdapter(CampaignCriterionServiceUse.Adapter.class)
public enum CampaignCriterionServiceUse {
  ...
  public static class Adapter extends TypeAdapter<CampaignCriterionServiceUse> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignCriterionServiceUse enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignCriterionServiceUse read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignCriterionServiceUse.fromValue(value);
    }
  }
}
