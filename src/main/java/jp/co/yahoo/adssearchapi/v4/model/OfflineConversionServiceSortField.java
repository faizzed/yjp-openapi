 ...
 */
@JsonAdapter(OfflineConversionServiceSortField.Adapter.class)
public enum OfflineConversionServiceSortField {
  ...
  public static class Adapter extends TypeAdapter<OfflineConversionServiceSortField> {
    @Override
    public void write(final JsonWriter jsonWriter, final OfflineConversionServiceSortField enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OfflineConversionServiceSortField read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OfflineConversionServiceSortField.fromValue(value);
    }
  }
}
