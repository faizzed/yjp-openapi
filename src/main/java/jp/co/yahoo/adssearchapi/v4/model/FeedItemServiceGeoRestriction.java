 ...
 */
@JsonAdapter(FeedItemServiceGeoRestriction.Adapter.class)
public enum FeedItemServiceGeoRestriction {
  ...
  public static class Adapter extends TypeAdapter<FeedItemServiceGeoRestriction> {
    @Override
    public void write(final JsonWriter jsonWriter, final FeedItemServiceGeoRestriction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FeedItemServiceGeoRestriction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FeedItemServiceGeoRestriction.fromValue(value);
    }
  }
}
