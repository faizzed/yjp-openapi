 ...
 */
@JsonAdapter(ReportDefinitionServiceReportType.Adapter.class)
public enum ReportDefinitionServiceReportType {
  ...
  public static class Adapter extends TypeAdapter<ReportDefinitionServiceReportType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReportDefinitionServiceReportType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReportDefinitionServiceReportType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReportDefinitionServiceReportType.fromValue(value);
    }
  }
}
