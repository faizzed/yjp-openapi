 ...
 */
@JsonAdapter(FeedItemServicePlaceholderType.Adapter.class)
public enum FeedItemServicePlaceholderType {
  ...
  public static class Adapter extends TypeAdapter<FeedItemServicePlaceholderType> {
    @Override
    public void write(final JsonWriter jsonWriter, final FeedItemServicePlaceholderType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FeedItemServicePlaceholderType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FeedItemServicePlaceholderType.fromValue(value);
    }
  }
}
