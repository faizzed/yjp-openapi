 ...
 */
@JsonAdapter(CampaignServiceGeoTargetType.Adapter.class)
public enum CampaignServiceGeoTargetType {
  ...
  public static class Adapter extends TypeAdapter<CampaignServiceGeoTargetType> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignServiceGeoTargetType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignServiceGeoTargetType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignServiceGeoTargetType.fromValue(value);
    }
  }
}
