 ...
 */
@JsonAdapter(AdGroupServiceIsRemove.Adapter.class)
public enum AdGroupServiceIsRemove {
  ...
  public static class Adapter extends TypeAdapter<AdGroupServiceIsRemove> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupServiceIsRemove enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupServiceIsRemove read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupServiceIsRemove.fromValue(value);
    }
  }
}
