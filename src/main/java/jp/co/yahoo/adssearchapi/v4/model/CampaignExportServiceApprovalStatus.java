 ...
 */
@JsonAdapter(CampaignExportServiceApprovalStatus.Adapter.class)
public enum CampaignExportServiceApprovalStatus {
  ...
  public static class Adapter extends TypeAdapter<CampaignExportServiceApprovalStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignExportServiceApprovalStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignExportServiceApprovalStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignExportServiceApprovalStatus.fromValue(value);
    }
  }
}
