 ...
 */
@JsonAdapter(CampaignServiceConversionOptimizerEligibility.Adapter.class)
public enum CampaignServiceConversionOptimizerEligibility {
  ...
  public static class Adapter extends TypeAdapter<CampaignServiceConversionOptimizerEligibility> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignServiceConversionOptimizerEligibility enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignServiceConversionOptimizerEligibility read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignServiceConversionOptimizerEligibility.fromValue(value);
    }
  }
}
