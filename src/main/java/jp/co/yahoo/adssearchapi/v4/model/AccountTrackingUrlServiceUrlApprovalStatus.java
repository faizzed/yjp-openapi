 ...
 */
@JsonAdapter(AccountTrackingUrlServiceUrlApprovalStatus.Adapter.class)
public enum AccountTrackingUrlServiceUrlApprovalStatus {
  ...
  public static class Adapter extends TypeAdapter<AccountTrackingUrlServiceUrlApprovalStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountTrackingUrlServiceUrlApprovalStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountTrackingUrlServiceUrlApprovalStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountTrackingUrlServiceUrlApprovalStatus.fromValue(value);
    }
  }
}
