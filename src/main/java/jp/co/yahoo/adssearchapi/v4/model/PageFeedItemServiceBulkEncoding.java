 ...
 */
@JsonAdapter(PageFeedItemServiceBulkEncoding.Adapter.class)
public enum PageFeedItemServiceBulkEncoding {
  ...
  public static class Adapter extends TypeAdapter<PageFeedItemServiceBulkEncoding> {
    @Override
    public void write(final JsonWriter jsonWriter, final PageFeedItemServiceBulkEncoding enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PageFeedItemServiceBulkEncoding read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PageFeedItemServiceBulkEncoding.fromValue(value);
    }
  }
}
