 ...
 */
@JsonAdapter(AccountManagementServiceAutoTaggingEnabled.Adapter.class)
public enum AccountManagementServiceAutoTaggingEnabled {
  ...
  public static class Adapter extends TypeAdapter<AccountManagementServiceAutoTaggingEnabled> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountManagementServiceAutoTaggingEnabled enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountManagementServiceAutoTaggingEnabled read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountManagementServiceAutoTaggingEnabled.fromValue(value);
    }
  }
}
