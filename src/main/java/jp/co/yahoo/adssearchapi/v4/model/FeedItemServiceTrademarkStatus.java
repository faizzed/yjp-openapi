 ...
 */
@JsonAdapter(FeedItemServiceTrademarkStatus.Adapter.class)
public enum FeedItemServiceTrademarkStatus {
  ...
  public static class Adapter extends TypeAdapter<FeedItemServiceTrademarkStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final FeedItemServiceTrademarkStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FeedItemServiceTrademarkStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FeedItemServiceTrademarkStatus.fromValue(value);
    }
  }
}
