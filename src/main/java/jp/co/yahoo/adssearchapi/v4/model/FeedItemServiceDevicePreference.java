 ...
 */
@JsonAdapter(FeedItemServiceDevicePreference.Adapter.class)
public enum FeedItemServiceDevicePreference {
  ...
  public static class Adapter extends TypeAdapter<FeedItemServiceDevicePreference> {
    @Override
    public void write(final JsonWriter jsonWriter, final FeedItemServiceDevicePreference enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FeedItemServiceDevicePreference read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FeedItemServiceDevicePreference.fromValue(value);
    }
  }
}
