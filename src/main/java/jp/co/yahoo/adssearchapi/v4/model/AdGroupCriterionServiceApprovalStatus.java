 ...
 */
@JsonAdapter(AdGroupCriterionServiceApprovalStatus.Adapter.class)
public enum AdGroupCriterionServiceApprovalStatus {
  ...
  public static class Adapter extends TypeAdapter<AdGroupCriterionServiceApprovalStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupCriterionServiceApprovalStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupCriterionServiceApprovalStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupCriterionServiceApprovalStatus.fromValue(value);
    }
  }
}
