 ...
 */
@JsonAdapter(AdGroupAdServiceDevicePreference.Adapter.class)
public enum AdGroupAdServiceDevicePreference {
  ...
  public static class Adapter extends TypeAdapter<AdGroupAdServiceDevicePreference> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupAdServiceDevicePreference enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupAdServiceDevicePreference read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupAdServiceDevicePreference.fromValue(value);
    }
  }
}
