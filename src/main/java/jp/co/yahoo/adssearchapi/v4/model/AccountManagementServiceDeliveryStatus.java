 ...
 */
@JsonAdapter(AccountManagementServiceDeliveryStatus.Adapter.class)
public enum AccountManagementServiceDeliveryStatus {
  ...
  public static class Adapter extends TypeAdapter<AccountManagementServiceDeliveryStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountManagementServiceDeliveryStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountManagementServiceDeliveryStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountManagementServiceDeliveryStatus.fromValue(value);
    }
  }
}
