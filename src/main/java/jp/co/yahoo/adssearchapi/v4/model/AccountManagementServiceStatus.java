 ...
 */
@JsonAdapter(AccountManagementServiceStatus.Adapter.class)
public enum AccountManagementServiceStatus {
  ...
  public static class Adapter extends TypeAdapter<AccountManagementServiceStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountManagementServiceStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountManagementServiceStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountManagementServiceStatus.fromValue(value);
    }
  }
}
