 ...
 */
@JsonAdapter(AdGroupServiceBidSource.Adapter.class)
public enum AdGroupServiceBidSource {
  ...
  public static class Adapter extends TypeAdapter<AdGroupServiceBidSource> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupServiceBidSource enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupServiceBidSource read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupServiceBidSource.fromValue(value);
    }
  }
}
