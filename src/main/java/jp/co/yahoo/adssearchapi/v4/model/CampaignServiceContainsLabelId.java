 ...
 */
@JsonAdapter(CampaignServiceContainsLabelId.Adapter.class)
public enum CampaignServiceContainsLabelId {
  ...
  public static class Adapter extends TypeAdapter<CampaignServiceContainsLabelId> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignServiceContainsLabelId enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignServiceContainsLabelId read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignServiceContainsLabelId.fromValue(value);
    }
  }
}
