 ...
 */
@JsonAdapter(ReportDefinitionServiceReportCompressType.Adapter.class)
public enum ReportDefinitionServiceReportCompressType {
  ...
  public static class Adapter extends TypeAdapter<ReportDefinitionServiceReportCompressType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReportDefinitionServiceReportCompressType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReportDefinitionServiceReportCompressType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReportDefinitionServiceReportCompressType.fromValue(value);
    }
  }
}
