 ...
 */
@JsonAdapter(AdGroupAdServiceTrademarkStatus.Adapter.class)
public enum AdGroupAdServiceTrademarkStatus {
  ...
  public static class Adapter extends TypeAdapter<AdGroupAdServiceTrademarkStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupAdServiceTrademarkStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupAdServiceTrademarkStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupAdServiceTrademarkStatus.fromValue(value);
    }
  }
}
