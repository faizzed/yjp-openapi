 ...
 */
@JsonAdapter(AuditLogServiceOutput.Adapter.class)
public enum AuditLogServiceOutput {
  ...
  public static class Adapter extends TypeAdapter<AuditLogServiceOutput> {
    @Override
    public void write(final JsonWriter jsonWriter, final AuditLogServiceOutput enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AuditLogServiceOutput read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AuditLogServiceOutput.fromValue(value);
    }
  }
}
