 ...
 */
@JsonAdapter(FeedItemServiceApprovalStatus.Adapter.class)
public enum FeedItemServiceApprovalStatus {
  ...
  public static class Adapter extends TypeAdapter<FeedItemServiceApprovalStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final FeedItemServiceApprovalStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FeedItemServiceApprovalStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FeedItemServiceApprovalStatus.fromValue(value);
    }
  }
}
