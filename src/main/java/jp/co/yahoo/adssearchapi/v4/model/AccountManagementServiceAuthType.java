 ...
 */
@JsonAdapter(AccountManagementServiceAuthType.Adapter.class)
public enum AccountManagementServiceAuthType {
  ...
  public static class Adapter extends TypeAdapter<AccountManagementServiceAuthType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountManagementServiceAuthType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountManagementServiceAuthType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountManagementServiceAuthType.fromValue(value);
    }
  }
}
