 ...
 */
@JsonAdapter(RetargetingListServiceRuleOperator.Adapter.class)
public enum RetargetingListServiceRuleOperator {
  ...
  public static class Adapter extends TypeAdapter<RetargetingListServiceRuleOperator> {
    @Override
    public void write(final JsonWriter jsonWriter, final RetargetingListServiceRuleOperator enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RetargetingListServiceRuleOperator read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RetargetingListServiceRuleOperator.fromValue(value);
    }
  }
}
