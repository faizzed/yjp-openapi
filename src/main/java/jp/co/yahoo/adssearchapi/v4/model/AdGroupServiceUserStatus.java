 ...
 */
@JsonAdapter(AdGroupServiceUserStatus.Adapter.class)
public enum AdGroupServiceUserStatus {
  ...
  public static class Adapter extends TypeAdapter<AdGroupServiceUserStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupServiceUserStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupServiceUserStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupServiceUserStatus.fromValue(value);
    }
  }
}
