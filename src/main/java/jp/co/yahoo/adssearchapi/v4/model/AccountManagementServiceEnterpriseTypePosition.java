 ...
 */
@JsonAdapter(AccountManagementServiceEnterpriseTypePosition.Adapter.class)
public enum AccountManagementServiceEnterpriseTypePosition {
  ...
  public static class Adapter extends TypeAdapter<AccountManagementServiceEnterpriseTypePosition> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountManagementServiceEnterpriseTypePosition enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountManagementServiceEnterpriseTypePosition read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountManagementServiceEnterpriseTypePosition.fromValue(value);
    }
  }
}
