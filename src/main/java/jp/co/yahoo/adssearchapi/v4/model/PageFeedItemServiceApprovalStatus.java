 ...
 */
@JsonAdapter(PageFeedItemServiceApprovalStatus.Adapter.class)
public enum PageFeedItemServiceApprovalStatus {
  ...
  public static class Adapter extends TypeAdapter<PageFeedItemServiceApprovalStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PageFeedItemServiceApprovalStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PageFeedItemServiceApprovalStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PageFeedItemServiceApprovalStatus.fromValue(value);
    }
  }
}
