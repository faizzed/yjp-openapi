 ...
 */
@JsonAdapter(AccountManagementServiceEnterpriseType.Adapter.class)
public enum AccountManagementServiceEnterpriseType {
  ...
  public static class Adapter extends TypeAdapter<AccountManagementServiceEnterpriseType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountManagementServiceEnterpriseType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountManagementServiceEnterpriseType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountManagementServiceEnterpriseType.fromValue(value);
    }
  }
}
