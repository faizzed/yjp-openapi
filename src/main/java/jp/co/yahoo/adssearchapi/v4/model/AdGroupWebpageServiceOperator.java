 ...
 */
@JsonAdapter(AdGroupWebpageServiceOperator.Adapter.class)
public enum AdGroupWebpageServiceOperator {
  ...
  public static class Adapter extends TypeAdapter<AdGroupWebpageServiceOperator> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupWebpageServiceOperator enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupWebpageServiceOperator read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupWebpageServiceOperator.fromValue(value);
    }
  }
}
