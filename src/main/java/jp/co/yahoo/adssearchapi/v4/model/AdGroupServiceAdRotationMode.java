 ...
 */
@JsonAdapter(AdGroupServiceAdRotationMode.Adapter.class)
public enum AdGroupServiceAdRotationMode {
  ...
  public static class Adapter extends TypeAdapter<AdGroupServiceAdRotationMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupServiceAdRotationMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupServiceAdRotationMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupServiceAdRotationMode.fromValue(value);
    }
  }
}
