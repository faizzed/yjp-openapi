 ...
 */
@JsonAdapter(RetargetingListServiceTargetListOwner.Adapter.class)
public enum RetargetingListServiceTargetListOwner {
  ...
  public static class Adapter extends TypeAdapter<RetargetingListServiceTargetListOwner> {
    @Override
    public void write(final JsonWriter jsonWriter, final RetargetingListServiceTargetListOwner enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RetargetingListServiceTargetListOwner read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RetargetingListServiceTargetListOwner.fromValue(value);
    }
  }
}
