 ...
 */
@JsonAdapter(RetargetingListServiceReachStorageStatus.Adapter.class)
public enum RetargetingListServiceReachStorageStatus {
  ...
  public static class Adapter extends TypeAdapter<RetargetingListServiceReachStorageStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final RetargetingListServiceReachStorageStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RetargetingListServiceReachStorageStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RetargetingListServiceReachStorageStatus.fromValue(value);
    }
  }
}
