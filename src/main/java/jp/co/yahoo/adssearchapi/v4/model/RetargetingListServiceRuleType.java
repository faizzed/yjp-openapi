 ...
 */
@JsonAdapter(RetargetingListServiceRuleType.Adapter.class)
public enum RetargetingListServiceRuleType {
  ...
  public static class Adapter extends TypeAdapter<RetargetingListServiceRuleType> {
    @Override
    public void write(final JsonWriter jsonWriter, final RetargetingListServiceRuleType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RetargetingListServiceRuleType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RetargetingListServiceRuleType.fromValue(value);
    }
  }
}
