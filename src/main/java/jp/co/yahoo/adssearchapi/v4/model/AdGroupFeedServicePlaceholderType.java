 ...
 */
@JsonAdapter(AdGroupFeedServicePlaceholderType.Adapter.class)
public enum AdGroupFeedServicePlaceholderType {
  ...
  public static class Adapter extends TypeAdapter<AdGroupFeedServicePlaceholderType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupFeedServicePlaceholderType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupFeedServicePlaceholderType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupFeedServicePlaceholderType.fromValue(value);
    }
  }
}
