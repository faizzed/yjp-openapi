 ...
 */
@JsonAdapter(AccountServiceIncludeTestAccount.Adapter.class)
public enum AccountServiceIncludeTestAccount {
  ...
  public static class Adapter extends TypeAdapter<AccountServiceIncludeTestAccount> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountServiceIncludeTestAccount enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountServiceIncludeTestAccount read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountServiceIncludeTestAccount.fromValue(value);
    }
  }
}
