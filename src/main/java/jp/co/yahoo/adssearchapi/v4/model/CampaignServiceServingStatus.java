 ...
 */
@JsonAdapter(CampaignServiceServingStatus.Adapter.class)
public enum CampaignServiceServingStatus {
  ...
  public static class Adapter extends TypeAdapter<CampaignServiceServingStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignServiceServingStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignServiceServingStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignServiceServingStatus.fromValue(value);
    }
  }
}
