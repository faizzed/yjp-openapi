 ...
 */
@JsonAdapter(AuditLogServiceSourceType.Adapter.class)
public enum AuditLogServiceSourceType {
  ...
  public static class Adapter extends TypeAdapter<AuditLogServiceSourceType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AuditLogServiceSourceType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AuditLogServiceSourceType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AuditLogServiceSourceType.fromValue(value);
    }
  }
}
