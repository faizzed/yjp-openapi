 ...
 */
@JsonAdapter(AccountManagementServiceIsAdultAccount.Adapter.class)
public enum AccountManagementServiceIsAdultAccount {
  ...
  public static class Adapter extends TypeAdapter<AccountManagementServiceIsAdultAccount> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountManagementServiceIsAdultAccount enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountManagementServiceIsAdultAccount read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountManagementServiceIsAdultAccount.fromValue(value);
    }
  }
}
