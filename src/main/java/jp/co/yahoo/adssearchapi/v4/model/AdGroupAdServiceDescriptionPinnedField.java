 ...
 */
@JsonAdapter(AdGroupAdServiceDescriptionPinnedField.Adapter.class)
public enum AdGroupAdServiceDescriptionPinnedField {
  ...
  public static class Adapter extends TypeAdapter<AdGroupAdServiceDescriptionPinnedField> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupAdServiceDescriptionPinnedField enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupAdServiceDescriptionPinnedField read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupAdServiceDescriptionPinnedField.fromValue(value);
    }
  }
}
