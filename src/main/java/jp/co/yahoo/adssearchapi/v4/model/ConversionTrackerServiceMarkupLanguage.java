 ...
 */
@JsonAdapter(ConversionTrackerServiceMarkupLanguage.Adapter.class)
public enum ConversionTrackerServiceMarkupLanguage {
  ...
  public static class Adapter extends TypeAdapter<ConversionTrackerServiceMarkupLanguage> {
    @Override
    public void write(final JsonWriter jsonWriter, final ConversionTrackerServiceMarkupLanguage enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ConversionTrackerServiceMarkupLanguage read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ConversionTrackerServiceMarkupLanguage.fromValue(value);
    }
  }
}
