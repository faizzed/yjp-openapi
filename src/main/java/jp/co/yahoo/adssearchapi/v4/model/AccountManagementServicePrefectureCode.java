 ...
 */
@JsonAdapter(AccountManagementServicePrefectureCode.Adapter.class)
public enum AccountManagementServicePrefectureCode {
  ...
  public static class Adapter extends TypeAdapter<AccountManagementServicePrefectureCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountManagementServicePrefectureCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountManagementServicePrefectureCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountManagementServicePrefectureCode.fromValue(value);
    }
  }
}
