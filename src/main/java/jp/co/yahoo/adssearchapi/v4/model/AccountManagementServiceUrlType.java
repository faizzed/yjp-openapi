 ...
 */
@JsonAdapter(AccountManagementServiceUrlType.Adapter.class)
public enum AccountManagementServiceUrlType {
  ...
  public static class Adapter extends TypeAdapter<AccountManagementServiceUrlType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountManagementServiceUrlType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountManagementServiceUrlType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountManagementServiceUrlType.fromValue(value);
    }
  }
}
