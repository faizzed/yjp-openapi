 ...
 */
@JsonAdapter(RetargetingListServiceIsAllVisitorRule.Adapter.class)
public enum RetargetingListServiceIsAllVisitorRule {
  ...
  public static class Adapter extends TypeAdapter<RetargetingListServiceIsAllVisitorRule> {
    @Override
    public void write(final JsonWriter jsonWriter, final RetargetingListServiceIsAllVisitorRule enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RetargetingListServiceIsAllVisitorRule read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RetargetingListServiceIsAllVisitorRule.fromValue(value);
    }
  }
}
