...
public enum AdGroupAdServiceAdType {
  ...
  public static class Adapter extends TypeAdapter<AdGroupAdServiceAdType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupAdServiceAdType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupAdServiceAdType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupAdServiceAdType.fromValue(value);
    }
  }
}
