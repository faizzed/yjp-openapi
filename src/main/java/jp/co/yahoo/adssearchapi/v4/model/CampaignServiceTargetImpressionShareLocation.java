 ...
 */
@JsonAdapter(CampaignServiceTargetImpressionShareLocation.Adapter.class)
public enum CampaignServiceTargetImpressionShareLocation {
  ...
  public static class Adapter extends TypeAdapter<CampaignServiceTargetImpressionShareLocation> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignServiceTargetImpressionShareLocation enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignServiceTargetImpressionShareLocation read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignServiceTargetImpressionShareLocation.fromValue(value);
    }
  }
}
