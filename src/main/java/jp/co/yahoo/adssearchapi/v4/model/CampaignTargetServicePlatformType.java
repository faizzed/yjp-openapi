 ...
 */
@JsonAdapter(CampaignTargetServicePlatformType.Adapter.class)
public enum CampaignTargetServicePlatformType {
  ...
  public static class Adapter extends TypeAdapter<CampaignTargetServicePlatformType> {
    @Override
    public void write(final JsonWriter jsonWriter, final CampaignTargetServicePlatformType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CampaignTargetServicePlatformType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CampaignTargetServicePlatformType.fromValue(value);
    }
  }
}
