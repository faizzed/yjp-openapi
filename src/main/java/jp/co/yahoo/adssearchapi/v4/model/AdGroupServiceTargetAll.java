 ...
 */
@JsonAdapter(AdGroupServiceTargetAll.Adapter.class)
public enum AdGroupServiceTargetAll {
  ...
  public static class Adapter extends TypeAdapter<AdGroupServiceTargetAll> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupServiceTargetAll enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupServiceTargetAll read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupServiceTargetAll.fromValue(value);
    }
  }
}
