 ...
 */
@JsonAdapter(AdGroupServiceContainsLabelId.Adapter.class)
public enum AdGroupServiceContainsLabelId {
  ...
  public static class Adapter extends TypeAdapter<AdGroupServiceContainsLabelId> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupServiceContainsLabelId enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupServiceContainsLabelId read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupServiceContainsLabelId.fromValue(value);
    }
  }
}
