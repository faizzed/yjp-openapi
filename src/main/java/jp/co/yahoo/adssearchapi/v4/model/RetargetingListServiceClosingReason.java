 ...
 */
@JsonAdapter(RetargetingListServiceClosingReason.Adapter.class)
public enum RetargetingListServiceClosingReason {
  ...
  public static class Adapter extends TypeAdapter<RetargetingListServiceClosingReason> {
    @Override
    public void write(final JsonWriter jsonWriter, final RetargetingListServiceClosingReason enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RetargetingListServiceClosingReason read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RetargetingListServiceClosingReason.fromValue(value);
    }
  }
}
