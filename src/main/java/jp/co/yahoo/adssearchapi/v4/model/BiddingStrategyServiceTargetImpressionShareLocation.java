 ...
 */
@JsonAdapter(BiddingStrategyServiceTargetImpressionShareLocation.Adapter.class)
public enum BiddingStrategyServiceTargetImpressionShareLocation {
  ...
  public static class Adapter extends TypeAdapter<BiddingStrategyServiceTargetImpressionShareLocation> {
    @Override
    public void write(final JsonWriter jsonWriter, final BiddingStrategyServiceTargetImpressionShareLocation enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public BiddingStrategyServiceTargetImpressionShareLocation read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return BiddingStrategyServiceTargetImpressionShareLocation.fromValue(value);
    }
  }
}
