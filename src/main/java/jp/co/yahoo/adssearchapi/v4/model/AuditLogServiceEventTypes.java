 ...
 */
@JsonAdapter(AuditLogServiceEventTypes.Adapter.class)
public enum AuditLogServiceEventTypes {
  ...
  public static class Adapter extends TypeAdapter<AuditLogServiceEventTypes> {
    @Override
    public void write(final JsonWriter jsonWriter, final AuditLogServiceEventTypes enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AuditLogServiceEventTypes read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AuditLogServiceEventTypes.fromValue(value);
    }
  }
}
