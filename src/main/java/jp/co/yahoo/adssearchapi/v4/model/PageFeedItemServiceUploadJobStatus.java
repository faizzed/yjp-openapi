 ...
 */
@JsonAdapter(PageFeedItemServiceUploadJobStatus.Adapter.class)
public enum PageFeedItemServiceUploadJobStatus {
  ...
  public static class Adapter extends TypeAdapter<PageFeedItemServiceUploadJobStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PageFeedItemServiceUploadJobStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PageFeedItemServiceUploadJobStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PageFeedItemServiceUploadJobStatus.fromValue(value);
    }
  }
}
