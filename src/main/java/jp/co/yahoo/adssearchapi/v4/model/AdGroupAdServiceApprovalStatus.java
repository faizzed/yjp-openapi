 ...
 */
@JsonAdapter(AdGroupAdServiceApprovalStatus.Adapter.class)
public enum AdGroupAdServiceApprovalStatus {
  ...
  public static class Adapter extends TypeAdapter<AdGroupAdServiceApprovalStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupAdServiceApprovalStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupAdServiceApprovalStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupAdServiceApprovalStatus.fromValue(value);
    }
  }
}
