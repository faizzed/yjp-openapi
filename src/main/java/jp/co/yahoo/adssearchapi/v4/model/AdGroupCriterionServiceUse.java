 ...
 */
@JsonAdapter(AdGroupCriterionServiceUse.Adapter.class)
public enum AdGroupCriterionServiceUse {
  ...
  public static class Adapter extends TypeAdapter<AdGroupCriterionServiceUse> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGroupCriterionServiceUse enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGroupCriterionServiceUse read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGroupCriterionServiceUse.fromValue(value);
    }
  }
}
