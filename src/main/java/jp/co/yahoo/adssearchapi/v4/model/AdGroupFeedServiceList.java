...
public class AdGroupFeedServiceList {
  ...
  public static final String SERIALIZED_NAME_AD_GROUP_FEED = "adGroupFeed";
  @SerializedName(SERIALIZED_NAME_AD_GROUP_FEED)
  ...
  **/
  ...
  public AdGroupFeedServiceList addAdGroupFeedItem(AdGroupFeed adGroupFeedItem) {
    if (this.adGroupFeed == null) {
      this.adGroupFeed = new ArrayList<AdGroupFeed>();
    }
